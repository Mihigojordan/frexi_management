...
const EmployeeProfile = () => {
    const { user, isLocked } = useEmployeeAuth();
    ...
    return (
        <div className="max-h-[90vh] overflow-y-auto p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-primary-900 mb-2">Employee Profile</h1>
                    <p className="text-primary-600">View your employee account information</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-primary-600 to-primary-700 px-8 py-12 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex items-center space-x-6">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold mb-2"> {user?.firstName + ' ' + user?.lastName || "Employee User"}</h2>
                                <p className="text-primary-100 text-lg">{user?.employeeEmail || user?.email}</p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-lg">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-lg font-semibold text-primary-900">
                                                {user?.employeeEmail || user?.email || "Not provided"}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    {user?.employeeId && (
                                        <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm font-medium text-primary-600 mb-1">Employee ID</p>
                                                <p className="text-lg font-semibold text-primary-900">
                                                    {user.employeeId}
                                                </p>
                                            </div>
                                    ...
                                    {user?.department && (
                                        <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm font-medium text-primary-600 mb-1">Department</p>
                                                <p className="text-lg font-semibold text-primary-900">
                                                    {user.department}
                                                </p>
                                            </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-lg">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center">
                                                <div className={`w-3 h-3 rounded-full mr-2 ${isLocked || user?.isLocked ? 'bg-red-500' : 'bg-green-500'}`}></div>
                                                <p className="text-lg font-semibold text-primary-900">
                                    ...
                                    {user?.lastLogin && (
                                        <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm font-medium text-primary-600 mb-1">Last Login</p>
                                                <p className="text-lg font-semibold text-primary-900">
                                    ...
                                    {user?.position && (
                                        <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm font-medium text-primary-600 mb-1">Position</p>
                                                <p className="text-lg font-semibold text-primary-900">
                                                    {user.position}
                                                </p>
                                            </div>
                ...
                <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
                    <div className="flex items-center justify-center text-primary-600">
                        ...
                        <p className="text-sm">
                            This is a read-only view of your employee account. 
                            Contact your administrator for any changes to your profile.
                        </p>
                    </div>
                </div>
            </div>
