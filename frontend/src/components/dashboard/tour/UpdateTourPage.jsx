        ...
        const fetchTourData = async () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    visaRequirements: tourData.visaRequirements || '',
                    language: tourData.language || '',
                    currencyUsed: tourData.currencyUsed || '',
                    areaKm2: tourData.areaKm2 ? tourData.areaKm2.toString() : '',
                    estimatedBudget: tourData.estimatedBudget ? tourData.estimatedBudget.toString() : '',
                    isActive: tourData.isActive !== undefined ? tourData.isActive : true
                });

           setPopularSites(() => {
    const sites = tourData.popularSites;
...
setHighlights(() => {
    ...
    return [];
                ...
                // Set existing images
                setExistingMainPhoto(tourData.mainPhotoUrl || null);
                const gallery = Array.isArray(tourData.gallery) ? tourData.gallery : [];
    ...
    const handleSubmit = async () => {
        ...
        try {
            const tourData = {
                ...
                description: tourService.parseDescription(formData.description) 
            };
            ...
            <div className="w-11/12 mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-primary-600 to-primary-600 px-6 py-4">
                        ...
                        <p className="text-primary-100 mt-1">Edit tour information and media</p>
                    </div>
                            ...
                            <div className="space-y-6 col-span-2 lg:col-span-1">
                                ...
                                <div>
                                    ...
                                    <div className={`rounded-lg border ${errors.description ? 'border-red-500' : 'border-gray-300'}`}>
                                        <ReactQuill
                                            theme="snow"
                                            value={tourService.parseDescription(formData.description)}
                                        ...
                                        {existingMainPhoto && !newMainPhoto && (
                                            <div className="mb-3">
                                                ...
                                                <div className="relative">
                                                    <img
                                                        src={tourService.getFullImageUrl(existingMainPhoto)}
            ...
            {existingGallery.map((imageUrl, index) => {
                ...
                return (
                    <div key={index} className="relative">
                        <img
                            src={tourService.getFullImageUrl(imageUrl)}
                            alt={`Gallery ${index + 1}`}
