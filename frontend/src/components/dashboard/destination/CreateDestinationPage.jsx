...
const removeGalleryPreview = (index) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await destinationServices.createDestination(destinationData, mainPhoto, galleryFiles);
      ...
      <div className="w-11/12 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-primary-600 to-primary-600 px-6 py-4">
            ...
            <p className="text-primary-100 mt-1">Add a new destination to your destination collection</p>
          </div>
